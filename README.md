...
![npm](https://img.shields.io/npm/v/ai-queue)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-queue)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Task queue implementation and management utilities

Message queue generator. Creates background job processing with retries and monitoring.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-queue.svg)](https://badge.fury.io/js/ai-queue)
